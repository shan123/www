...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
          <form class="form-horizontal" action="ipsheet-edit1.php" method="POST">
        ...
        if( isset($_POST['client'])) {
          ...
          if ($client == "" AND $region =="" AND $tab =="" AND $ip =="") {
            $query1 = "SELECT * from client, ipsheet WHERE client.clientId = ipsheet.clientId ORDER BY client.clientId ASC";
          ...
          while($row = mssql_fetch_array($result)) {
            ...
            echo "<td>" .  $row[6]  . "</td>";
            ?>
            <td><a href="ipsheet-edit2.php?id=<?php echo $row[0];?>&ipId=<?php echo $row[7];?>">Update</a></td> 
            <?php
            echo "</tr>";
          }
          echo "</tbody>";
